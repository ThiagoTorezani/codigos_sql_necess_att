...
--Este comando apaga o banco de dados se ele existir.--
...
--Este comando cria o usuário e a senha.--
...
--Este comando faz a troca de conexão.--
\c 'dbname=uvv user=thiago password=computacaoraiz'

--Este comando cria o esquema.--
CREATE SCHEMA lojas AUTHORIZATION thiago;

--Este comando faz com que o esquema padrão seja o "lojas" permanentemente.--
ALTER USER thiago SET SEARCH_PATH TO lojas, "$user", public;

--Este comando faz com que o esquema padrão seja o "lojas".--
...
ALTER TABLE produtos                                            ADD CONSTRAINT produtos_preco CHECK (preco_unitario >=0);
...
ALTER TABLE pedidos                                              ADD CONSTRAINT status_pedido CHECK (status IN ('CANCELADO', 'COMPLETO', 'ABERTO', 'PAGO', 'REEMBOLSADO', 'ENVIADO'));
...
ALTER TABLE envios                                                ADD CONSTRAINT status_envios CHECK (status IN('CRIADO', 'ENVIADO', 'TRANSITO', 'ENTRGUE'));
